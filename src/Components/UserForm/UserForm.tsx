        ...
        <form className='m-auto shadow-lg p-5 addform rounded-4' onSubmit={handleSubmit(onSubmit)}>
          <div className="row">
            <div className="col-md-6">
              <div className='mb-1'>
                ...
                <input type="text" className="form-control mt-2" placeholder="Enter First Name"
            ...
            <div className="col-md-6">
              <div className='mb-1'>
                ...
                <input type="text" className="form-control mt-2" placeholder="Enter Last Name"
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div className='mb-1'>
                ...
                <input type="number" className="form-control mt-2" placeholder="Enter Age"
          ...
          {!isViewMode && (
            <div className='text-center mt-4'>
              <button className='btn btn-warning w-50 mt-2 BtnSign'>
